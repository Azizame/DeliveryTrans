    ...
    return(
        ...
        <div className="footer">
            <ul>
                ...
                <li> <i><LocalPhoneIcon /></i> +7 987 654 32 10</li>
                <li className="aa"> <i><LocalPhoneIcon /></i>mail@mail.ru</li>
                <li className="bb"> <i><LocalPhoneIcon /></i>WhatsApp</li>
                <li className="cc"> <i><LocalPhoneIcon /></i>Москва, ул. Лобачика 11</li>
                <li className="ddd">Соц сети</li>
                <li><i><LocalPhoneIcon /></i> <i><LocalPhoneIcon /></i> 
                </li>
            </ul>
            <ul>
